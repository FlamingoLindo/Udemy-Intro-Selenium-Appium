...
1. Baixar Node.js
   ![node](/images/Appium/Aula%20-%2010/node.png)
   ...
   **Extra.:** Eu recomendo também a instalação do NVM, que é uma ferramenta de versionamento do Node
   ...
   ![nvm](/images/Appium/Aula%20-%2010/nvm.png)
...
5. Adicionando variáveis de ambiente
   ...
   - Clique em `Novo…` e no campo `Nome da variável` digite `ANDROID_HOME` e no `Valor da variável` cole o caminho do `SDK` e clique em `OK`
     ![a6](/images/Appium/Aula%20-%2010/a6.png)
...
8. Instalando o uiautomator2
   - No terminal digite `appium driver install uiautomator2`
     ![uiauto](/images/Appium/Aula%20-%2010/uiato.png)

9. Instalando o Appium Python Client
   - No terminal digite `pip install Appium-Python-Client`
     ![appcli](/images/Appium/Aula%20-%2010/appclient.png)
...
- De agora, sempre que você for iniciar o Appium digite o seguinte comando no terminal `appium --allow-cors`
  ![server](/images/Appium/Aula%20-%2010/server.png)
